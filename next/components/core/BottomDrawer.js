    ...
    <div
      className={clsx([
        "w-full overflow-hidden bg-white pl-64 transition-all duration-100 ease-in-out dark:bg-gray-800",
        {
          ...
          "h-0": !isOpen,
          "pl-[22rem]": isActiveSideFeature && isOpenNav,
          "pl-[18rem]": isActiveSideFeature && !isOpenNav,
          "pl-[14.2rem]": !isActiveSideFeature && isOpenNav && isExpandNav,
          "pl-[4rem]": !isActiveSideFeature && isOpenNav && !isExpandNav,
